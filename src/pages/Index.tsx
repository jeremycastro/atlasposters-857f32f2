      ...
      <section className="relative flex-1 flex items-center justify-center px-4 py-20 md:py-32 overflow-hidden">
        ...
        <div className="container max-w-6xl relative z-10">
          <div className="text-center space-y-8 mb-12">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight leading-[1.1]" style={{ filter: 'drop-shadow(0 4px 12px rgba(0, 0, 0, 0.4)) drop-shadow(0 2px 4px rgba(0, 0, 0, 0.3))' }}>
              Every Story
              <br />
